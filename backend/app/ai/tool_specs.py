...
_COORDINATOR_OPERATION_GUIDES = (
    ...
    _operation_guide("asset", "create", "创建 icon、SVG、Draw.io、Mermaid、Chart 或 Formula 文本资源。", _write_parameters("asset", "create", AssetCreatePayload, action="new"), action="new",
