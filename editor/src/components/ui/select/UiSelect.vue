...
<template>
  <SelectRoot :model-value="modelValue" :multiple="multiple" :disabled="disabled" @update:model-value="emit('update:modelValue', $event as SelectModelValue)">
    ...
    <SelectPortal><SelectContent position="popper" :side-offset="6" class="z-[900] max-h-72 min-w-[var(--reka-select-trigger-width)] overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-lg">
